...
To visualize the errormap first please put the errors.lut under the luts file of Fiji then open the errormap with Fiji you can use Fiji->Image->Lookup Tables->error map to see the artifacts distribution heat map.
